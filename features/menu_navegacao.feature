...
#  Scenario Outline: Navegar para as páginas usando o menu drop-down
#    Given que estou na página inicial do sistema
#    When clico no menu drop-down de navegação
#    And seleciono a opção "<pagina>"
#    Then sou redirecionado para a página de "<pagina>"